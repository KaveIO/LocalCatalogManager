...
public class ClientRepresentation {
   ...
   */
  @InjectLinks({
      @InjectLink(resource = Client.class, style = InjectLink.Style.ABSOLUTE, rel = "login",
          method = "login",
          type = "application/nl.kpmg.lcm.server.rest.client.types.LoginRequest+json"),
      @InjectLink(resource = Client.class, style = InjectLink.Style.ABSOLUTE, rel = "logout",
          method = "logout"),
      @InjectLink(resource = Version0.class, style = InjectLink.Style.ABSOLUTE, rel = "version.0",
          method = "getIndex")})
