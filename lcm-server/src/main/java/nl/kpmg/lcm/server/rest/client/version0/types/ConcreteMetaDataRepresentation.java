...
public class ConcreteMetaDataRepresentation extends MetaDataRepresentation
  ...
  public ConcreteMetaDataRepresentation() {}

  public ConcreteMetaDataRepresentation(MetaData metadata) {
    setItem(metadata);
  }
