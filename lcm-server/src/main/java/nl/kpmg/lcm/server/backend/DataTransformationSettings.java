...
/**
 * When the MetaData does not contains information how the data to be interpreted
 * then DataTransformationSettings must be used.
 * 
...
public class DataTransformationSettings {
  ...
  private Integer decimalPrecision = DEFAULT_DECIMAL_PRECISION;
    ...
    /**
     * As usually big amounts of data is transmitted it must be stored by chunks.
     * This method defines the maximum size of the chunk 
     * specified with count of inserted records per one insertion.
     * If noting is set explicitly by this method
     * then the default value will be used which is {@value #DEAFULT_MAXIMUM_INSERTED_RECORDS_PER_QUERY}
    ...
    /**
     * In case varchar size is missing in the metadata this value will be used
     * for constructing destination table. 
     * 
     * This setting will be taken in account only if destination is SQL like data sources.
     * 
     * If noting is set explicitly by this method
     * then the default value will be used which is {@value #DEFAULT_VARCHAR_SIZE}
    ...
    /**
     * In case decimal precision is missing in the metadata this value will be used
     * for constructing the destination table.
     * 
     * This setting will be taken in account only if destination is SQL like data sources.
     * 
     * If noting is set explicitly by this method
     * then the default value will be used which is {@value #DEFAULT_DECIMAL_PRECISION}
     * 
