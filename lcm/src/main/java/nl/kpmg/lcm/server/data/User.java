...
public class User extends AbstractModel {
     ...
     *
     * The User object is used for both the data model and in the Rest interface
     * representation. The javax.annotation.security.DenyAll is used for
     * controlling the visibility of the fields in the Rest interface.
     *
