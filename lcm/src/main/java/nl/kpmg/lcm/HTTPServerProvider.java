...
public class HTTPServerProvider {
	...
	public static HttpServer createHTTPServer(BasicConfiguration configuration, String baseUri, String baseFallbackUri, ResourceConfig rc, boolean clientAuth) throws ServerException {
	    ...
	    return GrizzlyHttpServerFactory.createHttpServer(
	        ...
	        rc,
	        true,
	        new SSLEngineConfigurator(sslContextConfigurator).setClientMode(false).setNeedClientAuth(clientAuth)
	    );
	}
}
