 ...
 * @author shristov
 */
public class DeleteUserGroupListener extends AbstractListener {
  private static final org.slf4j.Logger LOGGER = LoggerFactory
      .getLogger(DeleteUserGroupListener.class.getName());

  /**
   * @param dataContainer parent view.
   */
  public DeleteUserGroupListener(final DynamicDataContainer dataContainer,
  ...
  protected void deleteItem(String id) throws AuthenticationException, ServerException,
    ...
    restClientService.deleteUserGroup(id);
  }
}
