 ...
 * @author shristov
 */
public class DeleteAuthorizedLcmListener extends AbstractListener {
  private static final org.slf4j.Logger LOGGER = LoggerFactory
      .getLogger(DeleteAuthorizedLcmListener.class.getName());

  /**
   * @param dataContainer parent view.
   */
  public DeleteAuthorizedLcmListener(final DynamicDataContainer dataContainer,
  ...
  public void buttonClick(final Button.ClickEvent event) {
    ...
    AuthorizedLcm item = data.getItem();
    String message =
  ...
  protected void deleteItem(String id) throws AuthenticationException, ServerException,
    ...
    restClientService.deleteAuthorizedLcm(id);
  }
}
