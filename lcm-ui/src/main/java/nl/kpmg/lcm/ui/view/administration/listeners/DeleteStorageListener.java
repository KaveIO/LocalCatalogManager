 ...
 * @author shristov
 */
public class DeleteStorageListener extends AbstractListener {
  private static final org.slf4j.Logger LOGGER = LoggerFactory
      .getLogger(DeleteStorageListener.class.getName());

  /**
   * @param dataContainer parent view.
   */
  public DeleteStorageListener(final DynamicDataContainer dataContainer,
