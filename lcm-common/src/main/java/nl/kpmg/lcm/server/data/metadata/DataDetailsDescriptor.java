...
public class DataDetailsDescriptor extends AbstractMetaDataDescriptor {
  
  private String key;
 public DataDetailsDescriptor(MetaData metaData, String key) {
    super(metaData);
    this.key = key;
  }

  public DataDetailsDescriptor(Map map) {
    super(map);
  }
  ...
  public String getSectionName() {
    return "dynamic.data.items." + key + ".details";
  }
