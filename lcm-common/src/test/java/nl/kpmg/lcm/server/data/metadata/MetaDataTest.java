...
public class MetaDataTest {
  ...
  @Test
  public void testGetReturnNullOnNoValue()
  ...
  @Test
  public void testGetReturnFirstLevelValue()
      throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
  ...
  @Test
  public void testGetReturnSecondLevelValue()
      throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    final String expected = "value";
    String actual;

    MetaData metaData = new MetaData();
    metaData.set("firstLevelKey", new HashMap() {
      {
        put("secondLevelKey", expected);
      }
    });
  ...
  @Test
  public void testSetFirstLevelAttributes()
      throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    String expected = "value";
    String actual;
  ...
  @Test
  public void testSetSecondLevelAttributes()
      throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    String expected = "value";
    String actual;
  ...
  @Test
  public void testSetMulitpleSecondLevelAttributes()
      throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
